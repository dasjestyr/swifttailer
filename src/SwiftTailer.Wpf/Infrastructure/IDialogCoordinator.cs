...
namespace SwiftTailer.Wpf.Infrastructure
{
    ...
    public interface IDialogCoordinator
    {
        ...
        /// 
        /// </summary>
        /// <param name="context">Typically this should be the view model, which you register in XAML using <see cref="M:MahApps.Metro.Controls.Dialogs.DialogParticipation.SetRegister(System.Windows.DependencyObject,System.Object)"/>.</param><param name="title">The title of the MessageDialog.</param><param name="message">The message contained within the MessageDialog.</param><param name="settings">Optional settings that override the global metro dialog settings.</param>
        /// <returns>
        ...
        /// 
        /// </summary>
        /// <param name="context">Typically this should be the view model, which you register in XAML using <see cref="M:MahApps.Metro.Controls.Dialogs.DialogParticipation.SetRegister(System.Windows.DependencyObject,System.Object)"/>.</param><param name="title">The title of the LoginDialog.</param><param name="message">The message contained within the LoginDialog.</param><param name="style"/><param name="settings">Optional settings that override the global metro dialog settings.</param>
        /// <returns>
        /// The text that was entered or null (Nothing in Visual Basic) if the user cancelled the operation.
        /// </returns>
        ...
        /// 
        /// </summary>
        /// <param name="context">Typically this should be the view model, which you register in XAML using <see cref="M:MahApps.Metro.Controls.Dialogs.DialogParticipation.SetRegister(System.Windows.DependencyObject,System.Object)"/>.</param><param name="title">The title of the ProgressDialog.</param><param name="message">The message within the ProgressDialog.</param><param name="isCancelable">Determines if the cancel button is visible.</param><param name="settings">Optional Settings that override the global metro dialog settings.</param>
        /// <returns>
        ...
        /// 
        /// <para>
        /// You have to close the resulting dialog yourself with <see cref="M:MahApps.Metro.Controls.Dialogs.IDialogCoordinator.HideMetroDialogAsync(System.Object,MahApps.Metro.Controls.Dialogs.BaseMetroDialog,MahApps.Metro.Controls.Dialogs.MetroDialogSettings)"/>.
        /// </para>
        /// 
        /// </summary>
        /// <param name="context">Typically this should be the view model, which you register in XAML using <see cref="M:MahApps.Metro.Controls.Dialogs.DialogParticipation.SetRegister(System.Windows.DependencyObject,System.Object)"/>.</param><param name="dialog">The dialog instance itself.</param><param name="settings">An optional pre-defined settings instance.</param>
        /// <returns>
        ...
        /// A task representing the operation.
        /// </returns>
        /// <exception cref="T:System.InvalidOperationException">The <paramref name="dialog"/> is not visible in the window.
